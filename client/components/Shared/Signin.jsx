...
const Signin = ({ onSignIn, onForgotPassword, onSignUp, onClientSignin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsSigningIn(true); // Change button text to "Signing in..."
        ...
        if (result.error) {
            ...
            setIsSigningIn(false); // Revert button text to "Sign In" on failure
        } else {
                                ...
                                <form className="form w-100" onSubmit={handleSubmit}>
                                    ...
                                    <div className="d-grid mb-10">
                                        <button type="submit" className="btn btn-primary" disabled={isSigningIn}>
                                            <span className="indicator-label">{isSigningIn ? "Signing in..." : "Sign In"}</span>
                                        </button>
                                    </div>
